 ...
 * @see app/Http/Controllers/ArticleController.php:170
 ...
 * @see app/Http/Controllers/ArticleController.php:183
 * @route '/articles/{slug}'
 */
...
const ArticleController = { index, landing, show, create, store, edit, update, destroy }
