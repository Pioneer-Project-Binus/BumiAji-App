 ...
 * @see app/Http/Controllers/ProductController.php:308
 * @route '/products/{slug}'
 */
...
const ProductController = { index, show, create, store, exportMethod, edit, update, destroy, export: exportMethod }
