...
const ProductController = { indexPublic, showPublic, indexAdmin, create, store, exportMethod, archived, restore, deletePermanent, edit, update, showAdmin, destroy, export: exportMethod }
