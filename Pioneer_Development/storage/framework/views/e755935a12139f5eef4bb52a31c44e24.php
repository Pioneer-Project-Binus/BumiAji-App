...
<?php echo when(($export ?? true) && !$isInvokable, 'export '); ?>const <?php echo $method; ?> = (<?php echo $__env->make('wayfinder::function-arguments', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>): {
    url: string,
...
<?php echo $method; ?>.definition = {
    methods: [<?php $__currentLoopData = $verbs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $verb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo \Illuminate\Support\Js::from($verb->actual)->toHtml() ?><?php echo when(! $loop->last, ','); ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>],
    url: <?php echo $uri; ?>,
}
...
<?php echo $__env->make('wayfinder::docblock', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php echo $method; ?>.<?php echo $verb->actual; ?> = (<?php echo $__env->make('wayfinder::function-arguments', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>): {
    url: string,
...
<?php if($withForm): ?>
    <?php echo $__env->make('wayfinder::docblock', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    const <?php echo $method; ?>Form = (<?php echo $__env->make('wayfinder::function-arguments', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>): {
        action: string,
    ...
    <?php $__currentLoopData = $verbs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $verb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php echo $__env->make('wayfinder::docblock', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $method; ?>Form.<?php echo $verb->actual; ?> = (<?php echo $__env->make('wayfinder::function-arguments', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>): {
            action: string,
...
<?php endif; ?>
<?php /**PATH C:\Users\Leonel\OneDrive\Documents\Kuliah\Tugas_Kuliah\Coding\WEB\BumiAji-App\Pioneer_Development\vendor\laravel\wayfinder\src/../resources/method.blade.ts ENDPATH**/ ?>