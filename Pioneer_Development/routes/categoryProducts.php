...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/category-products/archived', [CategoryProductController::class, 'archivedIndex'])->name('category-products.archived');
    ...
    Route::put('/category-products/{slug}/restore', [CategoryProductController::class, 'restore'])->name('category-products.restore');
    Route::delete('/category-products/{slug}/permanent', [CategoryProductController::class, 'deletePermanent'])->name('category-products.deletePermanent');
});
